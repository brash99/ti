...
struct TI_A24RegStruct
{
  ...
  /** 0x0012C */          unsigned int blank5[(0x140-0x12C)/4];
  ...
  /** 0x001F4 */          unsigned int blank8[(0x2000-0x1F4)/4];
  /** 0x02000 */ volatile unsigned int SWB_status[(0x2200-0x2000)/4];
  /** 0x02200 */          unsigned int blank9[(0x2800-0x2200)/4];
  /** 0x02800 */ volatile unsigned int SWA_status[(0x3000-0x2800)/4];
  /** 0x03000 */          unsigned int blank10[(0xFFFC-0x3000)/4];
